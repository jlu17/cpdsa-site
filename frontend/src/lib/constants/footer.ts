...
export const SOCIAL_LINKS: Array<{ label: string; href: string; svgPath: string }> = [
  {
    label: 'Facebook',
    href: 'https://www.facebook.com/CentParkDanceSk8',
    svgPath: 'M18 2h-3a5 5 0 0 0-5 5v3H7v4h3v8h4v-8h3l1-4h-4V7a1 1 0 0 1 1-1h3z',
  },
  {
    label: 'Instagram',
    href: 'https://www.instagram.com/centralpark.danceskaters',
    svgPath:
  ...
  {
    label: 'Email',
    href: 'mailto:info@cpdsa.org',
    svgPath: 'M4 4h16c1.1 0 2 .9 2 2v12c0 1.1-.9 2-2 2H4c-1.1 0-2-.9-2-2V6c0-1.1.9-2 2-2zm0 0l8 9 8-9',
  },
  {
    label: 'YouTube',
    href: '#',
